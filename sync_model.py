...
def generate_extraction(image_path: str) -> PageExtraction:
...
"""
with open("/Users/parsashemirani/Main/Inbox/book_programs/outputs/reminate.md", "w") as f:
    f.write(jamie.markdown_content)
"""
