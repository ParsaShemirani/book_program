...
Figures that are just plain text themselves should rather be treated as main_text. Figures only include
images, charts, visuals, mathematical notation, etc. But plain text that is in a rectangle shape or
other decoration should not be treated as a figure, rather is should be appropriately inserted in the flow
of the main text.
